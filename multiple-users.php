      ...
      <div class="div-block-21">
        <div class="form-block-4 w-form">
          <form id="email-form" name="email-form" data-name="Email Form" class="form-3"><label for="name" class="field-label-4">Age range</label><select id="field" name="field" required="" class="select-field w-select"><option value="">Select your group age range</option><option value="">15-19</option><option value="Second">20-29</option><option value="Third">30-39</option><option value="">40-49</option><option value="Another Choice">50-59</option><option value="Another Choice">60+</option></select><label for="name" class="field-label-4">Anyone suffering from a know disease?</label>
            <div class="checkbox-field-2 w-checkbox"><input type="checkbox" id="checkbox" name="checkbox" data-name="Checkbox" class="checkbox-2 w-checkbox-input"><label for="checkbox" class="checkbox-label-2 w-form-label"><strong>Asthma</strong></label></div>
            <div class="checkbox-field-2 w-checkbox"><input type="checkbox" id="checkbox-3" name="checkbox-3" data-name="Checkbox 3" class="checkbox-2 w-checkbox-input"><label for="checkbox-3" class="checkbox-label-2 w-form-label"><strong>Seasonal allergies</strong></label></div>
            <div class="checkbox-field-2 w-checkbox"><input type="checkbox" id="checkbox-2" name="checkbox-2" data-name="Checkbox 2" class="checkbox-2 w-checkbox-input"><label for="checkbox-2" class="checkbox-label-2 w-form-label"><strong>General respiratory difficulty</strong></label></div><a href="dashboard.php"><input type="button" value="Start the sauna session" data-wait="Please wait..." class="submit-button-3 w-button"></a></form>
